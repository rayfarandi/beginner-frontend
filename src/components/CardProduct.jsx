...
const CardProduct = ({id, productName, description, rating, basePrice, discountPrice, price, image, handleDetails, tag }) => {
  return (
    <div className="relative flex justify-center w-fit h-fit">
      ...
      <div className="absolute w-11/12 h-[12.5rem] sm:h-5/6 bg-white top-[75%] p-1.5 sm:p-2 flex flex-col gap-1.5">
        <h1 className="font-semibold text-black text-sm sm:text-base" id="product-name">
          {productName}
        </h1>
