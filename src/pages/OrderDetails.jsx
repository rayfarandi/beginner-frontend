...
const ListOrderInformation = ({field, value, color}) => {
    return (
        ...
        <h5 className={`font-bold text-xs sm:text-base ${color === "white" ? 'text-white' : ''} ${color?  `text-[${color}]`: ''} ${field == "Status" ? " text-[0.6rem] sm:text-xs bg-gradient-to-br from-primary to-black py-1 px-2 rounded-full flex items-center" : ''}`}>
