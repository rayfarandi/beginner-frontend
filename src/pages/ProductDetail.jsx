...
const ProductDetail =()=>{
    return(
        ...
        <div className="flex-1 flex flex-col items-center gap-2 sm:gap-4 w-fit h-fit">
          <div className="">
            <img className="w-96 h-72 sm:h-96" src="./assets/detail-product4.jpg" />
          </div>
          <div className="flex gap-6">
            <div>
              <img className="w-28" src="./assets/detail-product1.jpg" />
            </div>
            <div>
              <img className="w-28" src="./assets/detail-product2.jpg" />
            </div>
            <div>
              <img className="w-28" src="./assets/detail-product3.jpg" />
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-2 sm:gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-3 sm:mt-4">
            <button className="flex-1 text-xs sm:text-sm bg-orange-500 rounded py-1.5">Buy</button>
      ...
      {/* recommen product */}
        <div className="h-fit sm:h-screen flex flex-col justify-center items-center w-5/6 gap-4 mt-8 mb-8 sm:mb-0">
          ...
          <div className="flex justify-center gap-4 sm:gap-12 mb-44 w-md sm:w-fit flex-wrap gap-y-44">
            ...
            <div className="relative flex justify-center w-fit h-fit">
              <div>
                <img className=" w-48 sm:w-60" src="./assets/home-product2.jpg" alt="" />
              </div>
              <div className="absolute bg-red-500 text-white rounded-3xl text-xs p-1.5 left-2 top-2">
                <h1>FLASH SALE!</h1>
              </div>
            ...
            <div className="relative hidden sm:flex justify-center w-fit h-fit">
              <div>
                <img className=" w-48 sm:w-60" src="./assets/home-product3.jpg" alt="" />
              </div>
              <div className="absolute bg-red-500 text-white rounded-3xl text-xs p-1.5 left-2 top-2">
                <h1>FLASH SALE!</h1>
              </div>
