...
```sh
  git clone https://github.com/rayfarandi/fwg17-beginner-frontend
...
[Back End Coffee Shop](https://github.com/rayfarandi/fwg17-backend-beginner)

## Technologies Used

The project structure is organized as follows: 
- src/: contains the source code of the project
- assets/: image and icon media
